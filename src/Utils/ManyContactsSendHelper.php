...
class ManyContactsSendHelper
{
    ...
    public function sendTemplateMediaMessage(string $number_phone, string $template, MediaMessageData $data)
    {
        try {
            $message_key = strtoupper(str_replace('.', '', uniqid('', true)));
            ...
            $response = $many_contacts_service->sendTemplateMediaMessage($number_phone, $template, $data->toArray());
    ...
    public function sendTemplateWithVariablesMessage(string $number_phone, string $template, VariablesMessageData $data)
    {
        try {
            ...
            $response = $many_contacts_service->sendTemplateWithVariablesMessage($number_phone, $template, $data->toArray());
